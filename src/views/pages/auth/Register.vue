...
export default {
    ...
    data() {
        return {
            ...
            dropdownValue: '',
            dropdownValues: [
                { name: 'اشتراك التجار', code: 'trader' }, // Updated label for trader
                { name: 'اشتراك الافراد', code: 'normal' } // Updated label for normal
            ]
        };
    },
    components: {
            ...
            try {
                ...
                this.$router.push({
                    ...
                    query: {
                        ...
                        user_type: this.dropdownValue.code // Pass the selected user_type
                    }
                });
            } catch (error) {
                if (error.response) {
