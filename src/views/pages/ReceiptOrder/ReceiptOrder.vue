    ...
    <div>
        <div class="card">
            ...
            <DataTable :value="receiptOrders" :lazy="true" :paginator="true" :rows="10" :totalRecords="totalRecords" @lazy-load="loadData">
                ...
                <Column header="طباعة">
                    <template #body="slotProps">
                        <button label="طباعة" icon="pi pi-print" class="p-button-text" @click="printReceiptOrder(slotProps.data)">طباعة</button>
                    </template>
                </Column>
            </DataTable>
...
export default {
    data() {
        return {
            ...
            productTypeOptions: [
    { value: 'Wholesale', label: 'بيع بالجملة' }, // Wholesale -> بيع بالجملة
    { value: 'Retail', label: 'بيع بالتجزئة' }    // Retail -> بيع بالتجزئة
],
            receiptOrders: [],
            totalRecords: 0,
            lazyParams: {
