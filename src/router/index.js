    ...
    routes: [
        {
            ...
            children: [
                ...
                },
                {
                    path: '/support-admin',
                    name: 'supportAdmin',
                    component: () => import('@/views/pages/Support/SupportAdmin.vue'),
                    meta: { requiresAuth: true }
                },
                {
                    path: '/rent-management',
                    name: 'rentManagement',
                    component: () => import('@/views/pages/rentManagement/rentManagement.vue'),
                    meta: { requiresAuth: true }
                },
                {
                    path: '/stock-management',
                    name: 'stockManagement',
                    component: () => import('@/views/pages/StockManagment/StockManagment.vue'),
                    meta: { requiresAuth: true }
                },
                {
                    path: '/stock-req',
                    name: 'stockReq',
                    component: () => import('@/views/pages/StockReq/StockReq.vue'),
                    meta: { requiresAuth: true }
                },
                {
                    path: '/profits',
